...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: "#f8f9fa", // Changed background for a lighter feel
  },
  header: {
    padding: 12,
    flexDirection: "row",
    justifyContent: "center",
    backgroundColor: "#e3e6eb", // Adjusted for softer contrast
  },
  logo: {
    height: 50,
    width: 150,
  ...
  inputBox: {
    ...
    fontSize: 16,
    borderRadius: 9,
    borderColor: "#ced4da", // Neutral border
  },
  btn: {
    backgroundColor: "#007bff", // Updated to blue for emphasis
    borderRadius: 9,
    alignSelf: "stretch",
    marginVertical: 18,
    padding: 10,
    borderWidth: 1,
    borderColor: "#0056b3", // Slightly darker border
  },
  btnDisabled: {
  ...
  error: {
    color: "#d14747", // Error color remains the same
    fontWeight: "bold",
  },
  avatarContainer: {
    flexDirection: "row",
